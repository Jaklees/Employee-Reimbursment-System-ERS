/*
These scripts can be adapted to for into your P1, and should be ample guidance to help consume your API
...
let userResourceURL = "http://localhost:8080/Jack-Klees-P1/user";
